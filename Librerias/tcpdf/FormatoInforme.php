...
require_once('../../cado/ClaseExamen.php');
...
$listar=$oexamen->FormatoInformeExamen($idexa);
...
$pdf->RoundedRect(14, 49, 180, 22.5, 5, '0101', 'DF',$style6);
...
$pdf->Text(180,54,$fecha);
$pdf->Text(180,59,$edad);
$pdf->Text(180,64,$dni);
$pdf->Text(180,69,$orden);
