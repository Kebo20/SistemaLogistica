                    ...
                    <table width="100%" style="font-size:13px; font-weight:bold;">
                        ...
                        <tr>
                            ...
                            <td><b>Nombre</b><br>
                                ...
                                <input type="hidden" id="cat_valor" name="valor">
                                <input name="nombre" id="cat_nombre" name="nombre" required class="input"></td>
...
<script src='js/log_categoria_producto.js'></script>
