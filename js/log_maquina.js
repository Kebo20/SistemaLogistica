...
function Listar(pagina) {
    ...
    $.ajax({
        ...
        url: 'controlador/Clogistica.php?op=LIS_MAQUINA&q=' + $("#buscar").val() + "&pagina=" + pagina,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            ...
            $.ajax({
                ...
                url: 'controlador/Clogistica.php?op=PAG_MAQUINA&q=' + $("#buscar").val(),
                type: "POST",
                dataType: "json",
...
$("#formEliminar").on("submit", function (e) {
    ...
    $.ajax({
        ...
        url: 'controlador/Clogistica.php?op=ELIMINAR_MAQUINA',
        type: "POST",
